...
<!DOCTYPE html>
<html lang="pt-BR">
<head><meta http-equiv="Cache-Control" content="no-cache, no-store, must-revalidate"><meta http-equiv="Pragma" content="no-cache"><meta http-equiv="Expires" content="0"><meta http-equiv="Cache-Control" content="no-cache, no-store, must-revalidate"><meta http-equiv="Pragma" content="no-cache"><meta http-equiv="Expires" content="0">
    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar">
            <div class="sidebar-header">
                <a href="dashboard_corrigido.php?v=1756145334?v=1756143942" class="sidebar-logo">
                ...
                <ul class="sidebar-menu">
                    ...
                    <div class="sidebar-group">
                        ...
                        <li class="sidebar-item">
                            <a href="dashboard_corrigido.php?v=1756145334?v=1756143942" class="sidebar-link active">
            ...
            <header class="page-header">
                <div class="breadcrumb">
                    <div class="breadcrumb-item">
                        <a href="dashboard_corrigido.php?v=1756145334?v=1756143942" class="breadcrumb-link">Início</a>
                    ...
                    <div class="card-header">
                        <div class="card-header-content">
                            <div class="card-title-section">
                                ...
                                <p class="card-subtitle">Explore nossa coleção de cursos profissionalizantes</p>
                            </div>
                            <div class="card-actions">
                                <button class="btn btn-sm btn-outline" onclick="refreshCursos()">
                                    <i class="fas fa-sync"></i>
                                    Atualizar
                                </button>
                                <button class="btn btn-sm btn-primary" onclick="showNovoCursoModal()">
                        ...
                        <div class="cursos-grid">
                            <?php if ($cursos_result && $cursos_result->num_rows > 0): ?>
                                <?php while ($curso = $cursos_result->fetch_assoc()): ?>
                                    <div class="curso-card <?php echo $curso['alunos_inscritos'] > 0 ? 'featured' : ''; ?>" onclick="verDetalhesCurso(<?php echo $curso['id']; ?>)">
                                        <div class="curso-categoria"><?php echo htmlspecialchars($curso['categoria']); ?></div>
                                        <h3 class="curso-titulo"><?php echo htmlspecialchars($curso['nome']); ?></h3>
                                        <div class="curso-meta">
                                            <span class="curso-nivel"><?php echo htmlspecialchars($curso['nivel']); ?></span>
                                            <span class="curso-duracao"><?php echo $curso['duracao_horas']; ?>h</span>
                                        </div>
                                        <div class="curso-preco">R$ <?php echo number_format($curso['preco'], 2, ',', '.'); ?></div>
                                        <div class="curso-stats">
                                            <span>👥 <?php echo $curso['alunos_inscritos']; ?> alunos</span>
                                            <span>⭐ <?php echo number_format($curso['avaliacao'], 1); ?></span>
                                        </div>
                                        <div class="curso-actions">
                                            <button class="btn btn-sm btn-outline" onclick="event.stopPropagation(); editarCurso(<?php echo $curso['id']; ?>)">
                                                <i class="fas fa-edit"></i>
                                                Editar
                                            </button>
                                            <button class="btn btn-sm btn-danger" onclick="event.stopPropagation(); apagarCurso(<?php echo $curso['id']; ?>)">
                            ...
                            <?php else: ?>
                                <div class="empty-state">
                                    ...
                                    <p>Clique em "Novo Curso" para criar seu primeiro curso e começar a oferecer educação de qualidade!</p>
                                    <button class="btn btn-primary" onclick="showNovoCursoModal()">
                                        <i class="fas fa-plus"></i>
