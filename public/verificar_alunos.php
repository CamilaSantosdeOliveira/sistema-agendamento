<?php
echo "<h1>🔍 VERIFICANDO ALUNOS NO BANCO DE DADOS</h1>";
include 'db.php';
...
echo "<h3>📊 Alunos no banco de dados:</h3>";
$result = $conn->query("SELECT id, nome, email, tipo_usuario, ativo FROM usuarios WHERE tipo_usuario = 'aluno' ORDER BY nome");
...
if ($result && $result->num_rows > 0) {
    ...
    echo "<p style='color: red;'>❌ Nenhum aluno encontrado no banco!</p>";
