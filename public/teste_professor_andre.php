...
echo "<h1>🔍 Teste de Aulas do Prof. André Oliveira</h1>";

// Buscar todas as aulas do Prof. André Oliveira (ID: 6)
$professor_id = 6;

echo "<h2>📊 Todas as Aulas do Prof. André Oliveira (ID: $professor_id)</h2>";
