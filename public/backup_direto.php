<?php
// Backup Direto - Sem redirecionamento
set_time_limit(120);
ini_set('memory_limit', '128M');

echo "<h1>🔄 Backup Direto - TUDO do Site</h1>";
...
$backupDir = __DIR__ . '/backup_direto_' . date('Y-m-d_H-i-s');
...
try {
    ...
    if (!$mysqli->connect_error) {
        ...
        $sqlContent = "-- Backup Direto - " . date('Y-m-d H:i:s') . "\n\n";
        ...
        file_put_contents($backupDir . '/banco_direto.sql', $sqlContent);
...
?>';
file_put_contents($backupDir . '/restaurar_direto.php', $restoreScript);

// 4. README
$readme = "BACKUP DIRETO DO SISTEMA\nData: " . date('Y-m-d H:i:s') . "\n\nCOMO RESTAURAR:\n1. Copie esta pasta\n2. Acesse restaurar_direto.php\n3. Pronto!";
file_put_contents($backupDir . '/README_DIRETO.txt', $readme);

echo "<div style='background: #d4edda; padding: 20px; border-radius: 8px; margin: 20px 0;'>";
echo "<h2>✅ Backup Direto Concluído!</h2>";
