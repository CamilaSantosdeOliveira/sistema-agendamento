...
$alunos_query = "SELECT DISTINCT u.*, COUNT(a.id) as total_aulas 
                 FROM usuarios u 
                 JOIN agendamentos a ON u.id = a.aluno_id 
                 WHERE a.professor_id = ? AND u.tipo_usuario = 'aluno'
                 GROUP BY u.id 
                 ORDER BY u.nome";
$stmt = $conn->prepare($alunos_query);
$stmt->bind_param("i", $professor_id);
$stmt->execute();
$alunos_professor = $stmt->get_result();

$total_alunos = $alunos_professor->num_rows;

$stmt = $conn->prepare("SELECT COUNT(*) as total FROM agendamentos WHERE professor_id = ?");
$stmt->bind_param("i", $professor_id);
$stmt->execute();
$total_aulas_alunos = (int)($stmt->get_result()->fetch_assoc()['total'] ?? 0);

$media_aulas_aluno = $total_alunos > 0 ? number_format($total_aulas_alunos / $total_alunos, 1, ',', '.') : '0';
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    ...
    <title>EduConnect - Meus Alunos</title>
    ...
    <div class="dashboard-container">
            ...
            <nav class="sidebar-nav">
                <ul class="sidebar-menu">
                    ...
                    <div class="sidebar-group">
                        ...
                        <li class="sidebar-item">
                            <a href="alunos_professor.php" class="sidebar-link active">
        ...
        <main class="main-content">
            <header class="page-header">
                <div class="page-title">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-current">Meus Alunos</span>
                    </div>
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    <div class="stat-header">
                        <div class="stat-title">Meus Alunos</div>
                        <div class="stat-icon"><i class="fas fa-users"></i></div>
                    </div>
                    <div class="stat-value"><?php echo $total_alunos; ?></div>
                    <div class="stat-change"><i class="fas fa-user stat-change-icon"></i> Alunos vinculados</div>
                    <div class="progress-bar"><div class="progress-fill" style="width:<?php echo min(($total_alunos / 20) * 100, 100); ?>%"></div></div>
                </div>
                <div class="stat-card success">
                    <div class="stat-header">
                        <div class="stat-title">Total de Aulas</div>
                        <div class="stat-icon"><i class="fas fa-chalkboard-user"></i></div>
                    </div>
                    <div class="stat-value"><?php echo $total_aulas_alunos; ?></div>
                    <div class="stat-change"><i class="fas fa-calendar-check stat-change-icon"></i> Aulas realizadas</div>
                    <div class="progress-bar"><div class="progress-fill success" style="width:<?php echo min(($total_aulas_alunos / 50) * 100, 100); ?>%"></div></div>
                </div>
                <div class="stat-card warning">
                    <div class="stat-header">
                        <div class="stat-title">Média por Aluno</div>
                        <div class="stat-icon"><i class="fas fa-chart-line"></i></div>
                    </div>
                    <div class="stat-value"><?php echo $media_aulas_aluno; ?></div>
                    <div class="stat-change"><i class="fas fa-calculator stat-change-icon"></i> Aulas/aluno</div>
                    <div class="progress-bar"><div class="progress-fill warning" style="width:65%"></div></div>
                </div>
            </div>
            ...
            <div class="content-card">
                ...
                <?php if ($alunos_professor->num_rows > 0): ?>
                    <table class="table">
                        <thead>
                            <tr>
                                <th>Aluno</th>
                        ...
                        <tbody>
                            <?php while ($aluno = $alunos_professor->fetch_assoc()): ?>
                                <tr>
                                    <td>
                                        <div style="font-weight: 600;"><?php echo $aluno['nome']; ?></div>
                                        <div style="font-size: 0.875rem; color: var(--secondary-color);">
                                            ID: <?php echo $aluno['id']; ?>
                                        </div>
                                    </td>
                                    <td><?php echo $aluno['email']; ?></td>
                                    <td><?php echo $aluno['telefone'] ? $aluno['telefone'] : '-'; ?></td>
                                    <td>
                                        <span style="font-weight: 600; color: var(--primary-color);">
                                            <?php echo $aluno['total_aulas']; ?> aulas
                                        </span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="aulas_professor.php" class="btn">Ver Aulas</a>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                        </tbody>
                ...
                <?php else: ?>
                    <div style="text-align: center; padding: 40px; color: var(--secondary-color);">
                        ...
                        <p style="font-size: 0.9rem; margin-top: 8px;">Os alunos aparecerão aqui quando você tiver aulas agendadas.</p>
                    </div>
                <?php endif; ?>
            </div>
        </main>
