...
$cursos_aluno_query = "SELECT DISTINCT c.*, u.nome as professor_nome, 
                       ...
                       MIN(a.data_agendamento) as primeira_aula,
                       MAX(a.data_agendamento) as ultima_aula
                       FROM agendamentos a 
            ...
            <nav class="sidebar-nav">
                <ul class="sidebar-menu">
                    ...
                    <div class="sidebar-group">
                        ...
                        <li class="sidebar-item">
                            <a href="meus_cursos_aluno.php" class="sidebar-link active">
        ...
        <main class="main-content">
            ...
            <?php if ($cursos_aluno->num_rows > 0): ?>
                <div class="course-grid">
                    <?php while ($curso = $cursos_aluno->fetch_assoc()): 
                        ...
                        $progresso = $curso['total_aulas'] > 0 ? min(round(($curso['total_aulas'] / max($curso['duracao_horas'], 1)) * 10), 100) : 0;
                    ?>
                        <div class="course-card">
                            ...
                            <div class="course-details">
                                <div class="detail-item">
                                    ...
                                    <span><?php echo htmlspecialchars($curso['professor_nome']); ?></span>
                                </div>
                                <div class="detail-item">
                                ...
                                <div class="detail-item">
                                    ...
                                    <span><?php echo $curso['duracao_horas']; ?> horas</span>
                                </div>
                                <div class="detail-item">
                            ...
                            <div class="course-progress">
                                ...
                                <div class="progress-text">
                                    ...
                                    <?php echo $progresso; ?>% Concluído
                                </div>
                            </div>
                            
                            <div class="course-actions">
                                <a href="minhas_aulas_aluno.php?curso_id=<?php echo $curso['id']; ?>" class="btn btn-primary">
                                    <i class="fas fa-play"></i>
                                    Continuar Estudo
                                </a>
                                <a href="detalhes_curso_aluno.php?id=<?php echo $curso['id']; ?>" class="btn btn-secondary">
            ...
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <p>Você ainda não está inscrito em nenhum curso. Explore os cursos disponíveis e comece sua jornada de aprendizado!</p>
