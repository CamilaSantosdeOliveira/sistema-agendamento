...
if ($metodo === 'POST') {
    ...
    try {
        ...
        $curso_query = "SELECT id, nome FROM cursos WHERE id = ?";
        ...
        $aluno_query = "SELECT id FROM usuarios WHERE email = ?";
        ...
        $check_query = "SELECT id FROM inscricoes WHERE curso_id = ? AND aluno_id = ?";
        $check_stmt = $conn->prepare($check_query);
        $check_stmt->bind_param('ii', $curso_id, $aluno_id);
        $check_stmt->execute();
